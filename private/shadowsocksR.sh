...
libsodium_url="https://github.com/letwen/Source-package-upload-plan/raw/master/eoria.anar/libsodium-1.0.16.tar.gz"
shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/letwen/Source-package-upload-plan/raw/master/eoria.anar/shadowsocksr-3.2.2.tar.gz"
